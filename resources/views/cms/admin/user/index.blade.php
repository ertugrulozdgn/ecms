    ...
    <div class="box box-primary">
        <div class="box-header">
            <div class="box-header with-border">
                ...
                <div align="right">
                    <a href="{{ action('Cms\Admin\UserController@create') }}"><button class="btn btn-success">Ekle</button></a>
                </div>
            </div>
            <div class="box-body">
                <table class="table table-striped">
                    ...
                    @foreach($users as $user)
                        <tr id="item-{{ $user->id }}" class="{{ $user->status == 0 ? 'alert alert-light' : ''}}">
                            ...
                            <td width="5"><a href="{{ action('Cms\Admin\UserController@edit', [ $user->id ]) }}"><i class="fa fa-pencil-square fa-lg"></i></a></td>
